                ...
                <tbody>
                    <tr>
                        {todos.map((todo, index) => (
                            <td key={index} className="flex justify-between odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700 px-6 py-4">
                                {todo}
